                    ...
                    <form action="{{ route('checkout.process') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control rounded-pill border-light-subtle bg-light"
                                    name="address" value="{{ old('address') }}" placeholder="Calle, número y colonia"
                                    required>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select rounded-pill border-light-subtle bg-light" name="state"
                                    required>
                        ...
                        <div class="bg-light p-3 rounded-4 border border-primary border-opacity-10 mb-4">
                            <div class="form-check">
                                ...
                                <p class="small text-muted mb-0">Te enviaremos los datos de la cuenta de DVC Clothing al
                                    finalizar tu orden.</p>
                            </div>
                        </div>
                        ...
                        @foreach (session('cart', []) as $id => $details)
                            ...
                            <li class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <div class="bg-light rounded-3 me-2 d-flex align-items-center justify-content-center"
                                        style="width: 50px; height: 50px; overflow: hidden;">
                                        @if (isset($details['image']))
                                            <img src="{{ asset('storage/' . $details['image']) }}" class="img-fluid"
                                ...
                                <span
                                    class="text-dark fw-semibold small">${{ number_format($details['price'] * $details['quantity'], 2) }}</span>
                            </li>
                        @endforeach
                    </ul>
